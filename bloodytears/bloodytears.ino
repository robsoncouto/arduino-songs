...
const PROGMEM int melody[] = {
  ...
  NOTE_A5, 4, NOTE_F5, 4,
  NOTE_A5, 4, NOTE_G5, 4,
  NOTE_D6, 4, PAUSE, 8, NOTE_C6, 8,
  PAUSE, 4, NOTE_AS5, 4,

  NOTE_A5, 4, NOTE_AS5, 8, NOTE_C6, 8, //15
  NOTE_F6, 8, PAUSE, 8, PAUSE, 4,
  ...
  NOTE_A5, 16, NOTE_D5, 16, NOTE_AS5, 16, NOTE_D5, 16, NOTE_C6, 16, NOTE_D5, 16, NOTE_AS5, 16, NOTE_D5, 16,
  NOTE_A5, 16, NOTE_D5, 16, NOTE_F5, 16, NOTE_D5, 16, NOTE_A5, 16, NOTE_D5, 16, NOTE_G5, 16, NOTE_D5, 16,
  NOTE_C6, 16, NOTE_C6, 16, NOTE_F6, 16, NOTE_D6, 8, PAUSE, 16, PAUSE, 8,
  PAUSE, 4, NOTE_C6, 16, NOTE_AS5, 16,

  NOTE_C6, -8,  NOTE_F6, -8, NOTE_D6, -4, //35
  NOTE_C6, 8, NOTE_AS5, 8,
  NOTE_C6, 8, NOTE_F6, 16, NOTE_D6, 8, PAUSE, 16, PAUSE, 8,
  PAUSE, 4, NOTE_C6, 8, NOTE_D6, 8,
  NOTE_DS6, -8, NOTE_F6, -8,

  NOTE_D6, -8, PAUSE, 16, NOTE_DS6, 8, PAUSE, 8, //40
  NOTE_C6, 8, NOTE_F6, 16, NOTE_D6, 8, PAUSE, 16, PAUSE, 8,
  PAUSE, 4, NOTE_C6, 8, NOTE_AS5, 8,
  NOTE_C6, -8,  NOTE_F6, -8, NOTE_D6, -4,
  NOTE_C6, 8, NOTE_AS5, 8,

  NOTE_C6, 8, NOTE_F6, 16, NOTE_D6, 8, PAUSE, 16, PAUSE, 8, //45
  PAUSE, 4, NOTE_C6, 8, NOTE_D6, 8,
  NOTE_DS6, -8, NOTE_F6, -8,
  ...
  NOTE_C5, 8, PAUSE, 8, NOTE_A4, -16, NOTE_AS4, -16, NOTE_C5, 16, //76
  ...
  NOTE_D6, 16, PAUSE, 8, NOTE_E4, 16, NOTE_F4, 16,
  
  //change of key B Major A# C# D# F# G#
  NOTE_GS4, 8, PAUSE, 8, NOTE_AS4, 8, PAUSE, 8,
  ...
  NOTE_D5, 4, PAUSE, 4,
  NOTE_CS5, 8, PAUSE, 8, NOTE_AS4, -16,  NOTE_B4, -16, NOTE_CS5, 16,
  NOTE_DS5, 16, NOTE_GS4, 16, NOTE_B4, 16, NOTE_GS4, 16, NOTE_CS5, 16, NOTE_GS4, 16, NOTE_DS5, 16, NOTE_GS4, 16,
  
  NOTE_CS5, 16, NOTE_FS4, 16, NOTE_AS4, 16, NOTE_FS4, 16, NOTE_FS5, 16, NOTE_FS4, 16, NOTE_DS5, 16, NOTE_E5, 16,
  NOTE_DS5, 4, PAUSE, 8, NOTE_DS5, 16,  NOTE_E5, 16,
  ...
  NOTE_CS6, 8, NOTE_FS6, 16, NOTE_DS6, 8, PAUSE,16, PAUSE,8, //107
  PAUSE,4, NOTE_CS6, 8, NOTE_B5, 8,
  NOTE_CS6,-8, NOTE_FS6, -8, NOTE_DS6, -4,
  NOTE_CS6, 8, NOTE_B5, 8,
  NOTE_CS6, 8, NOTE_FS6, 16, NOTE_DS6, 8, PAUSE,16, PAUSE,8,
  PAUSE,4, NOTE_CS6, 8, NOTE_B5, 8,
  NOTE_E6, -8, NOTE_F6, -8,
  
  NOTE_DS6,-8, PAUSE,16, NOTE_E6,8, PAUSE,16, PAUSE,16, //112
  NOTE_CS6, 8, NOTE_FS6, 16, NOTE_DS6, 8, PAUSE,16, PAUSE,8,
  PAUSE,4, NOTE_CS6, 8, NOTE_B5, 8,
  NOTE_CS6,-8, NOTE_FS6, -8, NOTE_DS6, -4,
  NOTE_CS6, 8, NOTE_B5, 8,
  
  NOTE_CS6, 8, NOTE_FS6, 16, NOTE_DS6, 8, PAUSE,16, PAUSE,8, //117
  PAUSE,4, NOTE_CS5, 8, NOTE_DS5, 8,
  NOTE_E5, -8, NOTE_F5, -8,
