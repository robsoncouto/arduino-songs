...
int melody[] = {
  ...
  NOTE_F5,1, //7
  PAUSE,4,  NOTE_F5,-4, NOTE_DS5,8,  NOTE_D5,8, NOTE_F5,1, NOTE_AS4,8, 
  NOTE_G4,-2, NOTE_F4,1, 
  NOTE_F4,1,
  ...
  NOTE_F4,-1,
  PAUSE,4,
  NOTE_D5,-4, PAUSE,16, NOTE_D5,16, NOTE_D5,2, 
  PAUSE,4, NOTE_D5,8, NOTE_DS5,8, NOTE_F5,8, NOTE_G5,8, NOTE_F5,8, NOTE_DS5,8, NOTE_D5,8,  

 
  NOTE_D5,-4, NOTE_DS5,16, NOTE_DS5,2, //23
  PAUSE,4, NOTE_G4,8, NOTE_C5,8, NOTE_D5,8, NOTE_DS5,8, NOTE_F5,8, NOTE_DS5,8, NOTE_D5,8,
  NOTE_C5,-4, PAUSE,16, NOTE_G4,2,
  PAUSE,4, NOTE_G4,8, NOTE_GS4,8, NOTE_AS4,8, NOTE_C5,8, NOTE_AS4,8, NOTE_GS4,8, NOTE_G5,8,
  
  NOTE_F4,-4,  NOTE_AS4,-4, NOTE_G4,2, //27
  PAUSE,8, NOTE_C4,8, NOTE_D4,8, NOTE_DS4,8, NOTE_G4,8, NOTE_C5,8,
  NOTE_D5,-4, PAUSE,16, NOTE_D5,-16, NOTE_D5,2,
  PAUSE,4, NOTE_D5,8, NOTE_DS5,8, NOTE_F5,8, NOTE_G5,8, NOTE_F5,8, NOTE_DS5,8, NOTE_D5,8,  
  NOTE_D5,-4, NOTE_DS5,-16, NOTE_DS5,2,
  
  PAUSE,4, NOTE_C5,8, NOTE_D5,8, NOTE_DS5,8, NOTE_F5,8, NOTE_DS5,8, NOTE_D5,8, NOTE_AS4,8,//32
  NOTE_AS4,-4, NOTE_C5,-4, NOTE_C5,-4,
  NOTE_F4,-4, PAUSE,8, NOTE_G4,4, NOTE_D5,4, NOTE_DS5,4,
  NOTE_D5,-4, PAUSE,16, NOTE_C5,16, NOTE_C5,2, 
  
  PAUSE,4, NOTE_D5,4, NOTE_DS5,4, NOTE_F5,4, //36 
  NOTE_G5,-4, PAUSE,16, NOTE_F5,2,
  NOTE_AS5,-4, NOTE_G5,-4, NOTE_DS5,4,
  
  NOTE_D5,-4, PAUSE,16, NOTE_DS5,2, //39
  PAUSE,4, NOTE_C5,8, NOTE_D5,8, NOTE_DS5,8, NOTE_E5,8, NOTE_F5,8, NOTE_FS5,8,
  NOTE_G5,-4, NOTE_F5,-4, PAUSE,4,  NOTE_AS5,2,

  NOTE_G5,4, NOTE_F5,8,  NOTE_G5,8,  PAUSE,8, NOTE_E5,8,//42
  PAUSE,8, NOTE_D5,8, NOTE_C5,-2, 
  PAUSE,8, NOTE_G4,8, NOTE_A4,8, NOTE_AS4,8, NOTE_C5,8, NOTE_D5,8, NOTE_DS5,8, 

  NOTE_DS5,-4,  NOTE_D5,-4,  NOTE_AS4,4, //45
  PAUSE,4, NOTE_DS5,8, NOTE_E5,8,  NOTE_F5,4, NOTE_E5,8, NOTE_DS5,8, NOTE_D5,8, NOTE_AS5,8,
  NOTE_C5,4, NOTE_G4,8, NOTE_D5,4, NOTE_G4,8, NOTE_D5,4, 
  PAUSE,8, NOTE_FS5,8, NOTE_G5,8, NOTE_FS5,8, NOTE_F5,8, NOTE_DS5,8, NOTE_D5,8, NOTE_DS5,8,

  PAUSE, 8, NOTE_AS5,8, NOTE_G5,8, NOTE_DS5,8, NOTE_F5,8, PAUSE,8, NOTE_G5,8, //49
  PAUSE,8, NOTE_FS5,8,  NOTE_F5,8, NOTE_DS5,8, NOTE_F5,8, NOTE_DS5,8, NOTE_D5,8, NOTE_DS5,8,
  NOTE_D5,-4,  NOTE_C5,-4, PAUSE,4, 
  PAUSE,4, NOTE_C5,8, NOTE_D5,8, NOTE_DS5,8, NOTE_D5,8, NOTE_C5,8, NOTE_AS4,8,
  ...
  NOTE_C4,8, NOTE_DS4,8, NOTE_G4,8, NOTE_C5,8, NOTE_DS5,8, NOTE_G5,8, PAUSE,8, NOTE_C5,8,
